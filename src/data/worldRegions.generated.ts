...
export const EUROPE_COUNTRY_IDS: readonly string[] = [
  "ALB",
  "AND",
  "AUT",
  "BEL",
...
export const SOUTH_AMERICA_COUNTRY_IDS: readonly string[] = [
  "ARG",
  "BOL",
  "BRA",
  "CHL",
...
export const ASIA_COUNTRY_IDS: readonly string[] = [
  "AFG",
  "ARE",
  "ARM",
  "AZE",
...
export const WORLD_CONTINENT_CAPITALS: CapitalEntry[] = [
  {
    "iso3": "ALB",
    "label": "Tirana",
    "lon": 19.82,
...
export const EXTRA_COUNTRY_NAME_FR: Record<string, string> = {
  "ALB": "Albanie",
  "AND": "Andorre",
  "BLR": "Biélorussie",
  "CZE": "Tchéquie",
...
export const EXTRA_FLAG_ALPHA2_BY_ISO3: Record<string, string> = {
  "ALB": "al",
  "AND": "ad",
  "BLR": "by",
  "CZE": "cz",
